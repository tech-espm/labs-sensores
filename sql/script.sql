...
-- { "end_device_ids": { "device_id": "soil01" }, "uplink_message": { "decoded_payload" : { "conductivity": 114, "humidity": 24.5, "temperature": 23.2 } } }
CREATE TABLE solo (
...
-- { "end_device_ids": { "device_id": "odor01" }, "uplink_message": { "decoded_payload": { "battery": 99, "h2s": 0.02, "humidity": 78, "nh3": 0.01, "temperature": 24.3 } } }
CREATE TABLE odor (
  id bigint NOT NULL AUTO_INCREMENT,
  data: datetime NOT NULL,
  id_sensor: tinyint NOT NULL,
...
-- { "end_device_ids": { "device_id": "presence01" }, "uplink_message": { "decoded_payload": { "battery": 99, "occupancy": "vacant" } } }
...
-- { "end_device_ids": { "device_id": "magnetic01" }, "uplink_message": { "decoded_payload": { "battery": 87, "door": "close", "install": "no" } } }
...
-- { "end_device_ids": { "device_id": "temperature01" }, "uplink_message": { "decoded_payload": { "humidity": 82, "temperature": 23.4 } } }
...
-- { "end_device_ids": { "device_id": "passage01" }, "uplink_message": { "decoded_payload": { "battery": 0, "period_in": 0, "period_out": 0 } } }
